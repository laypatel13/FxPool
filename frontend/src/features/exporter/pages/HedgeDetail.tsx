...
import { fetchMyPoolDetail, fetchOpenPoolSettings } from "../../../lib/services";
...
export default function HedgeDetail() {
  ...
  useEffect(() => {
    ...
    fetchOpenPoolSettings().then((s) => setTarget(s.min_pool_amount ?? 50000));
  }, [id]);
        ...
        <>
          <div className="mt-4 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              ...
              <h1 className="mt-1 font-display text-[26px] text-ink">{pool.currency} forward pool</h1>
