...
export default function AdminSettings() {
  ...
  return (
    <AdminShell>
      <h1 className="font-display text-[24px] text-ink">Default templates</h1>
      <p className="mt-1 text-[13px] text-ink-muted">
        Optional defaults for new bank pools. These are not mandatory matching rules — each bank sets minimum, target, and maximum on the pool itself.
      </p>
